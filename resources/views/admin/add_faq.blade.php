...
<form action="{{url('faq-created')}}" method="POST">
    @csrf
<div class="card-body">
<div class="form-group">
<label for="inputName">Question</label>
<input type="text" name="question" id="inputName" class="form-control{{($errors->first('question') ? " form-error" : "")}}">
...
<textarea id="inputDescription" name="answer" class="form-control{{($errors->first('answer') ? " form-error" : "")}}" rows="4"></textarea>
...
<div class="form-group">
<button class="btn btn-secondary" type="submit" style="margin-left: 121px;width: 200px;height: 48px;">Create</button>
</div>
