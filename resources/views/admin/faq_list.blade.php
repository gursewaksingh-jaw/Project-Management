...
<div class="col-md-6" style="margin-left:400px;margin-top:90px;">
    <div>
        <a href="add-faq" class="btn btn-secondary" style="margin-left: 810px; width: 132px;margin-bottom: 5px;">Add FAQ
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href={{"faq/delete/" .$val->id}}>Delete</a>
                            <a class="btn btn-success" href={{"faq/edit/" .$val->id}}>Update</a>
